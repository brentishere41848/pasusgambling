...
const MULTIPLIERS: Record<number, Record<RiskLevel, number[]>> = {
  ...
  12: {
    ...
    medium: [4.2, 2, 1, 0.58, 0.35, 0.2, 0.1, 0.2, 0.35, 0.58, 1, 2, 4.2],
    high: [9.5, 3.3, 1.25, 0.58, 0.28, 0.14, 0.06, 0.14, 0.28, 0.58, 1.25, 3.3, 9.5],
  },
  14: {
    low: [3.3, 1.8, 1.02, 0.72, 0.52, 0.4, 0.29, 0.2, 0.29, 0.4, 0.52, 0.72, 1.02, 1.8, 3.3],
    medium: [6.4, 2.8, 1.25, 0.7, 0.42, 0.25, 0.14, 0.08, 0.14, 0.25, 0.42, 0.7, 1.25, 2.8, 6.4],
    high: [14, 4.6, 1.6, 0.72, 0.34, 0.17, 0.08, 0.03, 0.08, 0.17, 0.34, 0.72, 1.6, 4.6, 14],
  },
  16: {
    low: [4.8, 2.2, 1.18, 0.78, 0.58, 0.44, 0.33, 0.25, 0.18, 0.25, 0.33, 0.44, 0.58, 0.78, 1.18, 2.2, 4.8],
    medium: [9.8, 3.7, 1.5, 0.82, 0.49, 0.29, 0.17, 0.1, 0.06, 0.1, 0.17, 0.29, 0.49, 0.82, 1.5, 3.7, 9.8],
    high: [24, 6.8, 2.1, 0.92, 0.42, 0.21, 0.1, 0.05, 0.02, 0.05, 0.1, 0.21, 0.42, 0.92, 2.1, 6.8, 24],
  },
};
