...
export const JackpotGame: React.FC = () => {
  ...
  return (
    <div className="max-w-2xl mx-auto p-4 md:p-5 space-y-6">
      ...
      <div className="bg-[linear-gradient(180deg,#1f1810_0%,#13100a_100%)] border border-amber-300/20 rounded-3xl p-5 space-y-4 shadow-[0_20px_70px_rgba(0,0,0,0.35)]">
        <div>
          <label className="text-[10px] font-black uppercase tracking-[0.18em] text-white/45 mb-2 block">Your Bet</label>
